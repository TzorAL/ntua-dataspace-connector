...
delete-env: delete-cluster-issuer disable-microk8s-services # disallow-firewall-ports
...
install-connector:
	...
	python decode_yaml.py $(input_values) $(output_values) $(deployment-name)/.env
